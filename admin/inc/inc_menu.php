...
<m:top item='1_' name='常用操作' display='block'>
  <m:item name='小说管理' link='book_admin.php' rank='a_List,a_AccList' target='main' />
  <m:item name='所有章节列表' link='content_list.php' rank='a_List,a_AccList' target='main' />
...
<m:top item='3_' name='采集管理' display='none' rank='co_NewRule,co_ListNote,co_ViewNote,co_Switch,co_GetOut'>
  <m:item name='采集规则管理' link='co_main.php' rank='co_ListNote' target='main' />
  <m:item name='导入采集规则' link='co_get_corule.php' rank='co_GetOut' target='main'/>
  <m:item name='采集过滤设置' link='pr_str_replace.php' rank='co_GetOut' target='main'/>
  <m:item name='添加单本采集' link='co_single.php' rank='co_GetOut' target='main'/>
</m:top>
