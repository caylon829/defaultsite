        ...
        $innertext='', $arcid=0, $idlist='', $channelid=0, $limit='', $att='', $order='desc', $subday=0, $noflag='',$tagid='', $pagesize=0, $isweight='N')
{
    ...
    $query = "SELECT arc.*,tp.typedir,tp.typename,tp.zuozhe,tp.startdate,tp.overdate,tp.booksize,tp.bookclick,tp.downloadurl,tp.typeimg,tp.corank,tp.isdefault,tp.defaultname,tp.namerule,
    ...
    if($idlist != '')
    {
        $query = "SELECT arc.*,tp.typedir,tp.typename,tp.zuozhe,tp.startdate,tp.overdate,tp.booksize,tp.bookclick,tp.downloadurl,tp.typeimg,tp.corank,tp.isdefault,tp.defaultname,tp.namerule,tp.namerule2,tp.ispart,
