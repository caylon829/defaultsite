...
class TypeLink
{
    ...
    function GetOptionArray($hid=0,$oper=0,$channeltype=0,$usersg=0,$child=1)
    {
        return $this->GetOptionList($hid,$oper,$channeltype,$usersg,$child);
    }

    function GetOptionList($hid=0,$oper=0,$channeltype=0,$usersg=0,$child=1)
    {
