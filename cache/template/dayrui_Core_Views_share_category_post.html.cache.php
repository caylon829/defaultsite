...
<div class="row my-content-top-tool">
    <div class="col-md-12 col-sm-12">
        ...
        <label style="margin-right:10px"><a href="<?php echo $field_url; ?>" class="btn blue"> <i class="fa fa-code"></i> <?php echo dr_lang('自定义字段'); ?></a></label>
        ...
        <div class="portlet-title tabbable-line">
            <ul class="nav nav-tabs" style="float:left;">
                ...
                <li class="<?php if ($page==1) { ?>active<?php } ?>">
                    <a href="#tab_1" data-toggle="tab" onclick="$('#dr_page').val('1')"> <i class="fa fa-table"></i> <?php echo dr_lang('内容设置'); ?> </a>
                </li>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group r1">
                            ...
                            <div class="col-md-9">
                                <div class="mt-radio-inline">
                                    <label class="mt-radio mt-radio-outline"><input type="radio" name="data[tid]" value="0" onclick="dr_tid(0)" <?php if (!$data['tid']) { ?> checked<?php } ?> /> <?php echo dr_lang('单网页'); ?> <span></span></label>
                                    <label class="mt-radio mt-radio-outline"><input type="radio" name="data[tid]" value="1" onclick="dr_tid(1)" <?php if ($data['tid']==1) { ?> checked<?php } ?> /> <?php echo dr_lang('内容模块'); ?> <span></span></label>
                                    <label class="mt-radio mt-radio-outline"><input type="radio" name="data[tid]" value="2" onclick="dr_tid(2)" <?php if ($data['tid']==2) { ?> checked<?php } ?> /> <?php echo dr_lang('外部地址'); ?> <span></span></label>
                                </div>
                            </div>
                        </div>
                        <?php }  if ($module['share']) { ?>
                        <div class="form-group dr_tid_1 " style="display: none">
                            ...
                            <div class="col-md-9">
                                ...
                                <span class="help-block"><?php echo dr_lang('当同一父级栏目下存在多个不同的模块栏目时，其父级栏目将自动转换为单页栏目'); ?></span>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo dr_lang('显示状态'); ?></label>
                            <div class="col-md-9">
                                <input type="checkbox" name="data[show]" value="1" <?php if ($data['show']) { ?>checked<?php } ?> data-on-text="<?php echo dr_lang('显示'); ?>" data-off-text="<?php echo dr_lang('隐藏'); ?>" data-on-color="success" data-off-color="danger" class="make-switch" data-size="small">
                                <span class="help-block"><?php echo dr_lang('前端循环调用不会显示'); ?></span>
                            </div>
                        </div>
                        <div class="form-group dr_tid_0">
                            <label class="col-md-2 control-label"><?php echo dr_lang('继承下级'); ?></label>
                            <div class="col-md-9">
                                <input type="checkbox" name="data[setting][getchild]" value="1" <?php if ($data['setting']['getchild']) { ?>checked<?php } ?> data-on-text="<?php echo dr_lang('是'); ?>" data-off-text="<?php echo dr_lang('否'); ?>" data-on-color="success" data-off-color="danger" class="make-switch" data-size="small">
                                <span class="help-block"><?php echo dr_lang('选择“是”时，将下级第一个页面数据作为当前的栏目，只对父级单网页有效'); ?></span>
                            </div>
                        </div>
                        <div class="form-group dr_tid_1">
                            <label class="col-md-2 control-label"><?php echo dr_lang('禁止修改'); ?></label>
                            <div class="col-md-9">
                                <input type="checkbox" name="data[setting][notedit]" value="1" <?php if ($data['setting']['notedit']) { ?>checked<?php } ?> data-on-text="<?php echo dr_lang('是'); ?>" data-off-text="<?php echo dr_lang('否'); ?>" data-on-color="success" data-off-color="danger" class="make-switch" data-size="small">
                ...
                <div class="tab-pane <?php if ($page==3) { ?>active<?php } ?>" id="tab_3">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="checkbox" name="data[setting][html]" value="1" <?php if ($data['setting']['html']) { ?>checked<?php } ?> data-on-text="<?php echo dr_lang('开启'); ?>" data-off-text="<?php echo dr_lang('关闭'); ?>" data-on-color="success" data-off-color="danger" class="make-switch" data-size="small">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <label style="margin-left:20px;"><?php echo dr_lang('<a href="'.dr_url('urlrule/index', ['hide_menu' => 1]).'" style="color:blue !important">[URL规则管理]</a>'); ?> </label>
