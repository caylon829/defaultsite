...
<script>
    function dr_page_content(id) {
        dr_iframe('<i class="fa fa-edit"></i> <?php echo dr_lang('编辑内容'); ?>','<?php echo dr_url(APP_DIR.'/category/content_edit'); ?>&id='+id, '90%', '90%');
    }
    ...
    <div class="table-scrollable">
        <table class="table table-striped table-bordered table-hover table-checkable dataTable">
            ...
            <tr class="heading">
                ...
                <?php }  if ($module['share']) { ?>
                <th width="70" style="text-align:center"> <?php echo dr_lang('模块'); ?> </th>
                <?php } ?>
