...
//            $endtime = $this->request->post('endtime');
        ...
        $list=array();
        $xi=0;
        //数据格式0=>[supplier_id,state,price,bill_unpaid,bill_paid,period]
...
//                    $list[$value['supplier_id']]['state_2'][$xi]['bill_unpaid']=round($value['bill_unpaid'],2);
//                    $xi++;
                }
                ...
                $list[$value['supplier_id']]['state_2'][$xi]['period']=$value['period'];
                $list[$value['supplier_id']]['state_2'][$xi]['price']=round($value['price'],2);
                $list[$value['supplier_id']]['state_2'][$xi]['bill_unpaid']=0;
            }
        }
        $temparr=array();
        $ii=1;
